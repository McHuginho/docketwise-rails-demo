...
class NotaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notum" do
    assert_difference("Notum.count") do
      post nota_url, params: { notum: { contenido: @notum.contenido, solicitante_id: @notum.solicitante_id } }
    end
  ...
  test "should update notum" do
    patch notum_url(@notum), params: { notum: { contenido: @notum.contenido, solicitante_id: @notum.solicitante_id } }
