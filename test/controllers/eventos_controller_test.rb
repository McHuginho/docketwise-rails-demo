...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference("Evento.count") do
      post eventos_url, params: { evento: { descripcion: @evento.descripcion, fecha: @evento.fecha, titulo: @evento.titulo, user_id: @evento.user_id } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { descripcion: @evento.descripcion, fecha: @evento.fecha, titulo: @evento.titulo, user_id: @evento.user_id } }
